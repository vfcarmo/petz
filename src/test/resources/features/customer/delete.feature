# language: en
@customer
Feature: Delete a customer by id
  User wants to delete a customer by id
  ...
  Scenario Outline: Delete a customer successfully
    Given the database is "online"
    When the user request deletion of the customer '<customerId>'
  ...
  Scenario Outline: Try to delete a customer with nonexistent customer id
    Given the database is "online"
    When the user request deletion of the customer '<customerId>'
  ...
  Scenario: Try to delete a customer when the database is offline
    Given the database is "offline"
    When the user request deletion of the customer '684e5119-6c38-4b20-9122-00faa9c8b413'
